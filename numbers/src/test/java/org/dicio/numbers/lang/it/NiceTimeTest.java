...
public class NiceTimeTest {
    ...
    public void random() {
        ...
        assertEquals("una e venti due di pomeriggio", pf.niceTime(dt).showAmPm(true).get());
        assertEquals("tredici e venti due", pf.niceTime(dt).use24Hour(true).get());
        assertEquals("tredici e venti due", pf.niceTime(dt).use24Hour(true).showAmPm(true).get());
    ...
    public void oClock() {
        ...
        assertEquals("tre in punto di pomeriggio", pf.niceTime(dt).showAmPm(true).get());
        assertEquals("quindici in punto", pf.niceTime(dt).use24Hour(true).get());
        assertEquals("quindici in punto", pf.niceTime(dt).use24Hour(true).showAmPm(true).get());
    ...
    public void afterMidnight() {
        ...
        assertEquals("mezzanotte e zero due", pf.niceTime(dt).showAmPm(true).get());
        assertEquals("mezzanotte e zero due", pf.niceTime(dt).use24Hour(true).get());
        assertEquals("mezzanotte e zero due", pf.niceTime(dt).use24Hour(true).showAmPm(true).get());
    ...
    public void quarterTo() {
        ...
        assertEquals("un quarto a mezzanotte", pf.niceTime(dt).showAmPm(true).get());
        assertEquals("un quarto a mezzanotte", pf.niceTime(dt).use24Hour(true).get());
        assertEquals("un quarto a mezzanotte", pf.niceTime(dt).use24Hour(true).showAmPm(true).get());
    ...
    public void tenAm() {
        ...
        assertEquals("dieci e zero tre di mattina", pf.niceTime(dt).showAmPm(true).get());
        assertEquals("dieci e zero tre", pf.niceTime(dt).use24Hour(true).get());
        assertEquals("dieci e zero tre", pf.niceTime(dt).use24Hour(true).showAmPm(true).get());
    ...
    public void tenPm() {
        ...
        assertEquals("dieci e zero tre", pf.niceTime(dt).get());
        assertEquals("dieci e zero tre di sera", pf.niceTime(dt).showAmPm(true).get());
